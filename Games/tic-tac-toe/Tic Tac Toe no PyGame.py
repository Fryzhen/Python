...
def setup():
    ...
    center = x_center + o_center
    side = x_side + o_side
    corner = x_corner + o_corner
    ...
    print(clear)
    print(line)
    number_of_players = str(input("Combiens de joueurs (1 ou 2)"))
...
def bot_play_v1():
    ...
    if xplays >= 3:
        ...
        if o_center == 0 and x_center == 0:

            if line[22] == "O" and line[66] == "O":
                return 22
            if line[24] == "O" and line[64] == "O":
                return 22
            if line[26] == "O" and line[62] == "O":
                return 22
            if line[46] == "O" and line[42] == "O":
                return 22
            if line[66] == "O" and line[22] == "O":
                return 22
            if line[64] == "O" and line[24] == "O":
                return 22
            if line[62] == "O" and line[26] == "O":
                return 22
            if line[42] == "O" and line[46] == "O":
                return 22
        ...
        if x_center == 0 and o_center == 0:

            if line[22] == "X" and line[66] == "X":
                return 22
            if line[24] == "X" and line[64] == "X":
                return 22
            if line[26] == "X" and line[62] == "X":
                return 22
            if line[46] == "X" and line[42] == "X":
                return 22
            if line[66] == "X" and line[22] == "X":
                return 22
            if line[64] == "X" and line[24] == "X":
                return 22
            if line[62] == "X" and line[26] == "X":
                return 22
            if line[42] == "X" and line[46] == "X":
                return 22
